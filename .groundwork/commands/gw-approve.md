---
name: gw-approve
description: Approve the card awaiting approval (or a whole phase in per-phase mode). Checks evidence, marks it done and commits it.
---
# gw-approve
...
## Must not
- Approve on the human's behalf, or without their explicit instruction.
