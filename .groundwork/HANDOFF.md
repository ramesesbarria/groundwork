...
- **Current card:** none (8.2 done and committed)
- **Status:** —
- **Last step:** 8.2 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 9.1
- **Failing checks:** none
