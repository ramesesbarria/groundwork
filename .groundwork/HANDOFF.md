...
- **Current card:** none (9.2 done and committed)
- **Status:** —
- **Last step:** 9.2 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 9.3
- **Failing checks:** none
