...
- **Current card:** none (9.5 done and committed)
- **Status:** —
- **Last step:** 9.5 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 9.6
- **Failing checks:** none
