...
- **Current card:** none (9.6 done and committed)
- **Status:** —
- **Last step:** 9.6 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 9.7
- **Failing checks:** none
