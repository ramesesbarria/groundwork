...
- **Current card:** none (10.2 done and committed)
- **Status:** —
- **Last step:** 10.2 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 10.3
- **Failing checks:** none
