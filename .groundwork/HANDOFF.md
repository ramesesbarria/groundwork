...
- **Current card:** none (8.1 done and committed)
- **Status:** —
- **Last step:** 8.1 reviewed and committed (the human asked for every planned change without stopping per card)
- **Next step:** `gw-next` for card 8.2
- **Failing checks:** none
