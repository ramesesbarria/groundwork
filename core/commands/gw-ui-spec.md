...
5. Write the agreed behavior into the card in `.groundwork/cards/` as **acceptance criteria**, one checkable statement each, e.g. "At 375px, the active card slides to the horizontal center; no scrollbar appears."
