---
title: "What it costs, and when it pays off"
---

The [calculator walkthrough](/docs/guides/walkthrough) took about 1.3M fresh tokens to build a
...
- **Mind the thinking level.** Max thinking produced 41% of the calculator's fresh tokens. The
  [`models`](/docs/reference/configuration#models-per-role) setting can give mechanical roles a cheaper
  model or setting.
