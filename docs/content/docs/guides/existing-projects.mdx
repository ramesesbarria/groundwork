...
description: "Groundwork works in a repo that already has code, history and conventions. Setup never rewrites your project — it maps it, records what's already true, and sets a baseline so old failures don't block new work."
---

<Callout type="info" title="Nothing is overwritten">
...
7. Imports rules from your existing instruction files — see
   [imported rules](/docs/concepts/lessons-ledger#imported-rules).
